...
export class LoginUseCase {
  ...
  async execute(input: any) {
    ...
    // A. Ekstraksi Nama Permission (String) -> Untuk middleware hasPermission("USER_READ")
    ...
    // B. Ekstraksi ID Permission (UUID) -> Untuk filter tabel Menu (permissionId)
    ...
    // 5. Kembalikan Payload yang Komplit dan Aman
    return {
